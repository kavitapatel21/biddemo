...
// show each of the users
            ...
            foreach ($users as $user) {
                ...
                if (current_user_can('edit_user', $user->ID)) {
                    ...
                    $edit = ($avatar == true) ? ('<strong style="position: relative; left: 6px;"><a class="users_edit_links" href="' . esc_url($edit_link) . '">' . esc_html($user->user_login) . '</a></strong>') : ('<strong style="top: -17px; left: 6px;"><a href="' . esc_url($edit_link) . '">' . esc_html($user->user_login) . '</a></strong>');
